...
class AdcolonyVideo {
    ...
    fun init(activity: Activity) {
        AdColony.configure(activity, "app90ad7872bb7d4cb299", "vze316b360c24045bfac")
    ...
    fun onResume(activity: Activity) {
        if (adcolonyVideo == null || adcolonyVideo!!.isExpired) {
            AdColony.requestInterstitial("vze316b360c24045bfac",
                ...
                override fun onExpiring(ad: AdColonyInterstitial?) {
                    super.onExpiring(ad)
                    AdColony.requestInterstitial("vze316b360c24045bfac", this)
                }
            })
        }
    }
